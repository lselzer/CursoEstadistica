...
path<- c( "C:\\Users\\cosca_000\\Dropbox\\Curso Hip?tesis Modelos y Datos  UNPSJB-CENPAT 2014\\Datos y scripts\\anova.csv") 
...
anov <-lm(respuesta~ fcat)     #Con esta hago expl?cito que utilizo al primer grupo como regerencia para calcular la ordenada al origen (es decir el mu del primer grupo)
anova(anov)
